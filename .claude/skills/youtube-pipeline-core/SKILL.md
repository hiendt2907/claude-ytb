...
description: Quy ước cốt lõi của pipeline claude-ytb — kiến trúc 4 khâu tuyến tính, chuỗi dataclass bất biến làm giàu dần qua dataclasses.replace(), config fail-fast và DRY_RUN. Dùng cho MỌI thay đổi đụng tới pipeline.py, pkg/models.py, hoặc khi nối/thêm khâu.
version: 1.0.0
